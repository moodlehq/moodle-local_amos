...
$string['emailintroduction'] = 'Dear {$a->firstname} {$a->lastname},<br/>
...
$string['privacy:metadata:db:amosstashes:name'] = '';
...
$string['subscribe_info'] = 'You have been subscribed successfully';
$string['subscription'] = 'Subscription';
$string['subscription_mail_subject'] = 'AMOS Notification - New language pack changes';
...
$string['unknown_language'] = 'Unknown language ({$a})';
$string['unstage'] = 'Unstage';
$string['unstageconfirm'] = 'Really?';
$string['unstaging'] = 'Unstaging';
$string['unsubscribe'] = 'Unsubscribe';
$string['unsubscribe_info'] = 'You have been unsubscribed successfully';
