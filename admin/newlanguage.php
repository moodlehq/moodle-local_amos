...
if ($data = $form->get_data()) {
    $component = new amos_component('langconfig', $data->langcode, amos_version::oldest_version());
    $data->langname = amos_string::fix_syntax($data->langname);
    $data->langnameint = amos_string::fix_syntax($data->langnameint);
    $component->add_string(new amos_string('thislanguage', $data->langname));
    $component->add_string(new amos_string('thislanguageint', $data->langnameint));
