...
class local_amos_importfile_auto_testcase extends local_amos_testcase {
    ...
    protected function set_up_english_strings(): void {
        ...
        $component = new mlang_component('foo_test', 'en', mlang_version::by_code(39));
        $component->add_string(new mlang_string('alpha', 'Alpha'));
        $stage->add($component);
        $component->clear();
        $stage->commit('Add alpha at 3.9', ['source' => 'unittest']);

        $component = new mlang_component('foo_test', 'en', mlang_version::by_code(400));
        $component->add_string(new mlang_string('beta', 'Beta'));
        $stage->add($component);
        $component->clear();
    ...
    public function test_strings_staged_at_correct_individual_versions() {
        ...
        $parsed = new mlang_component('foo_test', 'cs', mlang_version::latest_version());
        $parsed->add_string(new mlang_string('alpha', 'Alfa'));
        $parsed->add_string(new mlang_string('beta', 'Béta'));
        ...
        $component39 = $stage->get_component('foo_test', 'cs', mlang_version::by_code(39));
        ...
        $component400 = $stage->get_component('foo_test', 'cs', mlang_version::by_code(400));
    ...
    public function test_string_absent_from_english_is_skipped() {
        ...
        $parsed = new mlang_component('foo_test', 'cs', mlang_version::latest_version());
        $parsed->add_string(new mlang_string('alpha', 'Alfa'));
        $parsed->add_string(new mlang_string('nonexistent', 'Neexistující'));
    ...
    public function test_string_deleted_in_english_is_skipped() {
        ...
        $component = new mlang_component('foo_test', 'en', mlang_version::by_code(39));
        $component->add_string(new mlang_string('gamma', 'Gamma'));
        $stage->add($component);
        $component->clear();
        ...
        $component = new mlang_component('foo_test', 'en', mlang_version::by_code(400));
        $component->add_string(new mlang_string('gamma', null, null, true));
        $stage->add($component);
        $component->clear();
        ...
        $parsed = new mlang_component('foo_test', 'cs', mlang_version::latest_version());
        $parsed->add_string(new mlang_string('gamma', 'Gama'));
    ...
    public function test_updated_english_string_staged_at_new_version() {
        ...
        $component = new mlang_component('foo_test', 'en', mlang_version::by_code(39));
        $component->add_string(new mlang_string('delta', 'Delta'));
        $stage->add($component);
        $component->clear();
        ...
        $component = new mlang_component('foo_test', 'en', mlang_version::by_code(400));
        $component->add_string(new mlang_string('delta', 'Delta (revised)'));
        $stage->add($component);
        $component->clear();
        $stage->commit('Revise delta', ['source' => 'unittest']);

        $parsed = new mlang_component('foo_test', 'cs', mlang_version::latest_version());
        $parsed->add_string(new mlang_string('delta', 'Délta'));
