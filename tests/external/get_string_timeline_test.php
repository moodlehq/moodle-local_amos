 ...
 */
#[\PHPUnit\Framework\Attributes\CoversClass(get_string_timeline::class)]
final class get_string_timeline_test extends \local_amos_testcase {
    /**
     ...
     * @runInSeparateProcess
     */
    public function test_execute_candelete_without_manage_capability(): void {
        global $DB;
        $this->resetAfterTest(true);
